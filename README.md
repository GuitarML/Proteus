...
Go directly to [Colab](https://colab.research.google.com/github/GuitarML/Automated-GuitarAmpModelling/blob/proteus-capture/ProteusCapture.ipynb) to start training models.
